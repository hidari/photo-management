...
#### Google Play 写真パーミッション

- 2025 年 5 月以降、`READ_MEDIA_IMAGES` の広範なアクセスには Google の審査が必要
- Android Photo Picker の使用が推奨される
- Relay は Google Drive API 経由のアクセスなのでデバイスストレージの写真パーミッションとは別だが、アップロード時のファイル選択には Photo Picker を使う
